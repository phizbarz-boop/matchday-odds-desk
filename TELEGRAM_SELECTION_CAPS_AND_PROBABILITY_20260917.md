# Telegram scheduled Auto Pick rules (17 September 2026)

- 10x, 20x, 50x: maximum 30 selections; minimum per-leg model probability 80%; match winners only.
- 100x: maximum 40 selections; minimum per-leg probability 70%; match winners only.
- 1000x, 10000x: maximum 40 selections; minimum per-leg probability 70%; winners first, other supported markets when needed.
