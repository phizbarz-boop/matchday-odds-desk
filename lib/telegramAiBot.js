...
function probabilityKeyboard(){return{inline_keyboard:[[{text:'60%',callback_data:'set:prob:60'},{text:'65%',callback_data:'set:prob:65'},{text:'70%',callback_data:'set:prob:70'}],[{text:'75%',callback_data:'set:prob:75'},{text:'80%',callback_data:'set:prob:80'},{text:'85%',callback_data:'set:prob:85'}],[{text:'90%',callback_data:'set:prob:90'},{text:'⬅️ Builder',callback_data:'action:builder'}]]}}
