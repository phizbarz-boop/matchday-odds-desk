...
const PLANS = {
  ...
  elite: { id:'elite', name:'Elite', priceNgn:20000, dailyTickets:10, dailyAnalyzes:5, dailyLlmMessages:75, maxTargetOdds:1000, maxSelections:40, sports:['football','basketball','hockey','all'], copyHub:true, savedPreferences:true, description:'Highest limits, advanced analyzer access and Copy Hub rankings.' }
};
